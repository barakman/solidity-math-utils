...
from FixedPoint.AdvancedMath import optimalLog
from FixedPoint.AdvancedMath import generalLog
from FixedPoint.AdvancedMath import OPT_LOG_MAX_VAL
...
print('    uint256 internal constant LAMBERT_CONV_RADIUS = {0:#0{1}x};'.format(LAMBERT_CONV_RADIUS,maxLen))
print('    uint256 internal constant LAMBERT_POS2_SAMPLE = {0:#0{1}x};'.format(LAMBERT_POS2_SAMPLE,maxLen))
print('    uint256 internal constant LAMBERT_POS2_MAXVAL = {0:#0{1}x};'.format(LAMBERT_POS2_MAXVAL,maxLen))
print('    uint256 internal constant LAMBERT_POS3_MAXVAL = {0:#0{1}x};'.format(LAMBERT_POS3_MAXVAL,maxLen))
