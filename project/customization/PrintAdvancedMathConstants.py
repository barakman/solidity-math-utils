...
LAMBERT_POS3_MAXVAL = AdvancedMath.lambertPos3MaxVal(FIXED_1,LAMBERT_POS2_MAXVAL+1)
...
print(f'    uint256 internal constant LAMBERT_POS3_MAXVAL = {LAMBERT_POS3_MAXVAL:#0{maxLen}x};')
