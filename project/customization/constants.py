...
LAMBERT_NEG2_PART_N  =   1 # The portion of the negative convergence radius to approximate using a lookup table instead of with a Taylor series
LAMBERT_NEG2_PART_D  = 100 # The portion of the negative convergence radius to approximate using a lookup table instead of with a Taylor series
...
LAMBERT_POS2_SIZE_N  =  24 # The size above the positive convergence radius to approximate using a lookup table instead of with a Taylor series
LAMBERT_POS2_SIZE_D  =   1 # The size above the positive convergence radius to approximate using a lookup table instead of with a Taylor series
