...
terms = AdvancedMath.lambertPos1Terms(1<<SCALE_1,LAMBERT_POS1_TERMS,LAMBERT_POS2_SIZE_N,LAMBERT_POS2_SIZE_D,LAMBERT_POS2_SAMPLES)
...
for n in range(2,len(terms)):
    ...
    str4 = ['+'  ,'-'  ][n%2]
    str5 = ['add','sub'][n%2]
    print('        xi = xi * x >> SCALE_1; res {}= xi * {}; // {} x^({}-1) * ({}! * {}^({}-1) / {}!)'.format(str4,str2,str5,str3,str1,str3,str3,str3))
print('')
